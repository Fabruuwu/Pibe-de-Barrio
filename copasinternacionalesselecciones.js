/**
 * copasinternacionalesselecciones.js
 * -----------------------------------------
 * Todas las competencias internacionales DE SELECCIONES: Copa América,
 * Finalissima y Mundial de Selecciones. Maneja convocatorias, minijuegos
 * propios de cada torneo y el fixture progresivo del Mundial.
 *
 * Depende de: data.js (PAISES, LIGAS_POR_PAIS), estado.js (Estado),
 * minijuegos.js (crearCabeceraMinijuego).
 * -----------------------------------------
 */
...
// ============================================
// SECCIÓN: UEFA Champions League (antes champions.js)
// -----------------------------------------
// Sistema progresivo (toda la copa, como el Mundial de Clubes). Un
// minijuego distinto por posición, con dificultad creciente desde la
// Fase de Grupos hasta la Gran Final.
// Depende de: data.js (CLUBES_POR_DIVISION), estado.js (Estado),
// minijuegos.js (crearCabeceraMinijuego), y de lo de más arriba en este
// mismo archivo (mostrarInstructivoInternacional, mostrarCartelInternacional,
// asegurarPlazaCampeonContinental, agendarMundialClubes).
// ============================================
/**
 * champions.js
 * -----------------------------------------
 ...
 *
 * Depende de: data.js (CLUBES_POR_DIVISION), estado.js (Estado),
 * minijuegos.js (crearCabeceraMinijuego), copasinternacionalesclubes.js (mostrarInstructivoInternacional,
